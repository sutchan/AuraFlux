...
## 核心规范体系 (Current Standard: v1.7.9)

以下文档位于 `openspec/` 目录下，代表了本项目的最新技术标准：

1.  **[01 架构与设计规范](./01_architecture_spec.md)** - 同步 v1.7.9 R3F 性能优化。
...
6.  **[06 持久化与国际化规范](./06_storage_and_i18n_spec.md)** - 包含 v1.7.9 全量同步的 10 种语言标准。
7.  **[07 部署与环境规范](./07_deployment_guide.md)**
8.  **[08 测试与验证](./08_testing_and_validation.md)**
9.  **[09 营销与宣传文档](./09_marketing_and_press.md)**

---
*Aura Flux Project Specification - Version 1.7.9*