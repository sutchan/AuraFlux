...
## 核心规范体系 (Current Standard: v1.6.68)

以下文档位于 `openspec/` 目录下，代表了本项目的最新技术标准：

1.  **[01 架构与设计规范](./01_architecture_spec.md)** - 同步 V1.6.68 运行时优化。
2.  **[02 音频引擎与信号规范](./02_audio_engine_spec.md)**
3.  **[03 视觉生成渲染规范](./03_rendering_spec.md)** - 包含 Neural Flow V3.2.4 的数值安全性修复。
...
---
*Aura Flux Project Specification - Version 1.6.68*