...
## 核心规范体系 (Current Standard: v1.6.80)

以下文档位于 `openspec/` 目录下，代表了本项目的最新技术标准：

1.  **[01 架构与设计规范](./01_architecture_spec.md)** - 同步 V1.6.75 运行时优化。
