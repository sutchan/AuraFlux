...
### UI/UX
*   **🎨 Playback:** Polished the Library tab UI. The playback mode toggle (Repeat All, Repeat One, Shuffle) now uses cleaner, industry-standard icons and includes tooltips for better accessibility.
