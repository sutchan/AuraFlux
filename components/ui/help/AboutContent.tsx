        ...
        <div className="space-y-6 animate-fade-in-up">
            ...
            <div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                    <TechBadge label={tech.gemini || "Gemini 3 Intelligence"} colorClass="text-purple-300" />
                    <TechBadge label={tech.react || "React 19 Core"} colorClass="text-blue-300" />
                    <TechBadge label={tech.webgl || "WebGL Acceleration"} colorClass="text-green-300" />
                    <TechBadge label={tech.audio || "Web Audio API"} colorClass="text-yellow-300" />
                    <TechBadge label={tech.canvas || "Offscreen Canvas"} colorClass="text-orange-300" />
                    <TechBadge label={tech.edge || "Edge Computing"} colorClass="text-pink-300" />
                </div>
            </div>
