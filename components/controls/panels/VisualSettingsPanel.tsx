...
export const VisualSettingsPanel: React.FC = () => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
            ...
            <div className="space-y-3">
                ...
                <div className="pt-0">
                    ...
                    {!settings.cycleColors ? (
                        <div className="grid grid-cols-9 gap-1.5 p-1 animate-fade-in-up">
        ...
        <BentoCard title={t?.visualPanel?.aiBg || "AI Inspiration Background"} className="py-2.5">
            <div className="space-y-3">
                <div className="flex gap-2">
                    ...
                    {settings.aiBgUrl && (
                        <button onClick={() => setSettings(p => ({ ...p, aiBgUrl: '' }))} className="w-10 h-10 rounded-xl bg-red-500/10 text-red-400 flex items-center justify-center hover:bg-red-500/20">
      ...
      {/* Column 2: Engine Selection */}
      <div className="space-y-3">
        <BentoCard 
            title={t?.visualizerMode || "Visual Synthesis"} 
            className="py-2.5 h-full"
            action={
        ...
        >
            <div className="grid grid-cols-2 gap-2 pb-1 lg:max-h-[380px] overflow-y-auto custom-scrollbar pr-1">
