...
export const ar = {
  ...
  hints: {
    ...
    monitor: 'تمرير إدخال الميكروفون إلى مكبرات الصوت. تحذير: قد يسبب ارتجاع صوتي.',
    ...
    hideCursor: 'إخفاء مؤشر الماوس تلقائيًا بعد فترة من الخمول.'
  },
  ...
  helpModal: {
    ...
    howItWorksSteps: [
      ...
      '2. المشاهدة: شغل الموسيقى. استخدم "الإعدادات المسبقة الذكية" لتغيير الجو فوراً.',
      '3. التخصيص: انتقل إلى الوضع "المتقدم" لضبط الحساسية و FFT و "النص المخصص".',
      '4. التفاعل: اسحب لتغيير الوضع/الحساسية. ضغطة طويلة لـ الذكاء الاصطناعي.',
